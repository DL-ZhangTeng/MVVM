...
import com.zhangteng.app.mvvm.repository.BaseListMvvmDbDemoDbRepository
...
class BaseListMvvmDbDemoDbViewModel : BaseLoadingViewModel() {
    private val mRepository by lazy { BaseListMvvmDbDemoDbRepository() }
        ...
        launchUI {
            launchFlow {
                ...
                .flatMapConcat {
                    ...
                    } else throw IException(it.errorMsg, it.errorCode)
                }
